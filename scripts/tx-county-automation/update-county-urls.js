...
const ALL_UPDATES = {
  ...
  'Coleman':      { url: 'https://esearch.colemancad.org/', platform: 'bis' },
  'Comal':        { url: 'https://esearch.comalad.org/', platform: 'bis' },
  'Crosby':       { url: 'https://esearch.crosbycad.org/', platform: 'bis' },
  ...
  'Terry':        { url: 'https://esearch.terrycad.org/', platform: 'bis' },
  'Trinity':      { url: 'https://esearch.trinitycad.org/', platform: 'bis' },
